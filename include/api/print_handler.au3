...
with _AutoItObject_Class()
	...
	.AddProperty('__ptr')
	.AddProperty('__type', 1, 'CefPrintHandler')

	.AddMethod('OnPrintStart', 	'__CefPrintHandler_OPSt')
	.AddMethod('OnPrintSettings',	'__CefPrintHandler_OPSe')
	.AddMethod('OnPrintDialog', 	'__CefPrintHandler_OPD')
	.AddMethod('OnPrintJob', 		'__CefPrintHandler_OPJ')
	.AddMethod('OnPrintReset', 	'__CefPrintHandler_OPR')
	.AddMethod('GetPDFPaperSize', 	'__CefPrintHandler_GPPS')

	global $__CefPrintHandler = .Object
